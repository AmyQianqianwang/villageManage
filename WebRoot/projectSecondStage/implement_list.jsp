...
String titleStr=(String)request.getAttribute("TITLE_STR");
	...
	<div class="mainTable">
		...
		<div class="tableName">
			...
			<div class="headerTableName">
				<span>项目管理   &gt; <a style="text-decoration: none;" href="${basePath }projectSecondStage/index.jsp"> 项目实施与监察</a> &gt;<%=titleStr %></span>
			</div>
		</div>
			...
			<table id="dataTable" align="center">
				...
				<tr class="dataTableFoot">
					<td height="25" colspan="12">
						<form id="PageForm" action="${basePath}implement_getList.action" method="post">
