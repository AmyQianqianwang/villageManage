			...
			<div class="rowStyle">
				...
				<div class="edit">
					<div class="forImgIcon" style="margin-left:35px; margin-right:3px;">
						<img src="${basePath }images/icon_pen.png" alt="验收" />
					</div>
					<div class="forA">
						<a href="${basePath}accept_preAdd.action?proId=${r.proId}" target="_self">验收</a>
					</div>										
				</div>
			</div><!-- end rowStyle -->
			</c:forEach>
