	...
	<div class="mainTable">
		<div class="tableName">
			...
			<div class="headerTableName">
				<span>用户管理 &gt;<a href="${basePath }user_userList.action">用户列表</a>&gt;新增用户</span>
			</div>
		</div>
		...
		<div class="forTableSC" id="fss" style="background: lavender;">
			<%--新增表格--%>
			<form action="${basePath }user_addUser.action" method="post">
				<table style="width: 600px; margin: 0 auto; border: 0px solid #ddd; background-color: #fff; margin-top: 10px; margin-bottom: 10px;">
					<tr>
						...
						<td><input type="text" class="forText" name="username" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="password" name="password" class="forText" />
						</td>
					</tr>
					<tr>
						<td><span class="forPoint">*&nbsp;</span><span>确认密码</span>
						</td>
						<td><input type="password" name="passwordagain" class="forText" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="useroffice" class="forText" />
						</td>
					</tr>
					<tr>
